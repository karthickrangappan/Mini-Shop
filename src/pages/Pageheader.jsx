...
const Pageheader = () => {
    ...
    return (
        <div className="relative py-16 md:py-24 bg-[#FBFBFB] overflow-hidden border-b border-gray-100">
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
                <div className="flex flex-col items-center text-center">
                    <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-[#c9a84c] mb-3 block opacity-80">
                        {page.subtitle}
                    </span>

                    <h1 className="text-4xl md:text-7xl font-black text-[#121212] tracking-tighter leading-tight italic mb-8">
                        {page.title}
                    </h1>
